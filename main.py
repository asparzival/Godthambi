...
async def addchat(_, message): 
    ...
    if not is_kuki:
        ...
        await message.reply_text(f"✅ | Successfully\nguardian Chatbot of this Group is set to @{message.chat.username}\n Requested by [{message.from_user.first_name}](tg://user?id={message.from_user.id})\n© @sandapodalama")
    else:
        await message.reply_text(f"Already Setup GUARDIAN AIbot of this Group Is @{message.chat.username}")
    ...
    if message.chat.type != "private":
        buttons = InlineKeyboardMarkup(
            [[InlineKeyboardButton(text="Click here",
                url=f"t.me/GUARDIAN_AI_BOT    ?start")]])
        ...
        buttons = [[InlineKeyboardButton("Support", url="https://t.me/sandapodalama"),
                    ...
                    InlineKeyboardButton("Repo", url="https://github.com/asparzival/Godthambi")
                    ]]
...
async def help(client, message):
    ...
    if message.chat.type != "private":
        buttons = InlineKeyboardMarkup(
            [[InlineKeyboardButton(text="Click here",
                url=f"t.me/GUARDIAN_AI_BOT?start=help_")]])
        await message.reply("Contact me in PM",
                            reply_markup=buttons)
